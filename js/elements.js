...
export const orderProductCount = document.querySelector('.order__product-count');
export const modalProductCount = document.querySelector('.modal-product__count');
...
export const modalProductContainer = document.querySelector('.modal-product__container');
